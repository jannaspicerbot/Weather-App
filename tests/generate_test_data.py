...
class WeatherDataGenerator:
    ...
    def generate_realistic_weather(self, start_date, days=30, interval_minutes=5):
        ...
        while current_date < end_date:
            ...
            humidity = int(base_humidity - (tempf - base_temp) * 0.5 + random.uniform(-5, 5))
            ...
            pressure_variation = 0.3 * math.sin(day_of_year * 2 * math.pi / 30)  # Monthly cycle
            ...
            if 6 <= hour_of_day <= 20:  # Daytime
                ...
                seasonal_solar = 1.0 + 0.3 * math.sin((day_of_year - 80) * 2 * math.pi / 365)
                solarradiation = 800 * solar_factor * seasonal_solar + random.uniform(-50, 50)
...
def main():
    ...
    parser.add_argument('--db', type=str, default='ambient_weather_test.db',
