...
"""
PyInstaller DEBUG spec file for Weather App (macOS)
...
app = BUNDLE(
    coll,
    name='WeatherApp_Debug.app',
    icon=str(project_root / 'weather_app' / 'resources' / 'icons' / 'weather-app.icns'),
    bundle_identifier='com.weatherapp.debug',
    info_plist={
        'CFBundleName': 'Weather App (Debug)',
        'CFBundleDisplayName': 'Weather App (Debug)',
        'CFBundleVersion': '1.0.0',
        'CFBundleShortVersionString': '1.0.0',
        'NSHighResolutionCapable': 'True',
        'LSUIElement': '0',  # Show in dock for debug (easier to see console)
    },
)
